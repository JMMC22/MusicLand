...
function uploadTrack(req, res) {
    ...
    if (!titulo || !req.files) return res.status(200).send({ message: "Enviar datos necesarios." })
...
function getUserTracks(req, res) {
...
function updateTrack(req, res) {
    ...
    if (!update.status) return res.status(200).send({ message: "Enviar datos necesarios." })
